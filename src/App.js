...
const SEASONAL_DATES = {
  d39: ["fall"], d40: ["fall"], d55: ["fall"], d54: ["fall"],   d36: ["winter"], d167: ["winter"],
 d57: ["spring","summer","fall"],
  d38: ["summer"],
...
{id:"d22",title:"Sunrise Walk",description:"Set the alarm stupid early. Drive to a scenic overlook, lakefront, or park. Watch the sunrise with coffee in hand. Being up before the world makes it your private moment.",category:"outdoor",budget:5,difficulty:"easy",duration:120,vibe:["romantic","intimate","adventurous"],instructions:["Check sunrise time, set alarm 45 min before","Prep coffee in a thermos the night before","Drive to your spot in comfortable clothes","Walk around as the sky changes","Find a spot to sit and watch the full sunrise","Stop for breakfast on the way home"],materials:[{name:"Travel thermos",price:15}],variations:["Mountain sunrise . drive to a high point","Lake version . find a dock or pier","City sunrise . rooftop or bridge with skyline"],is_trending:false,is_top_week:false,is_new_release:false},
...
{id:"d38",title:"Meteor Shower Night",description:"Check NASA's meteor shower calendar, drive to a dark outdoor spot, set up sleeping bags and blankets, and watch shooting stars all night. Peak romance.",category:"outdoor",budget:50,difficulty:"moderate",duration:480,vibe:["romantic","adventurous","intimate"],instructions:["Check NASA for upcoming meteor showers . Perseids (Aug), Geminids (Dec) are best","Use DarkSiteFinder.com to find a low-light-pollution area","Pack sleeping bags, blankets, pillows, thermos with hot drinks","Arrive by 10pm so your eyes adjust to the dark","Set up camp at your spot . sleeping bags side by side","Download a star map app to identify what you're seeing","Stay until at least 1am for peak activity","Optional: stay for sunrise if you're feeling it"],materials:[{name:"Sleeping bags (2)",price:70},{name:"Telescope",price:70},{name:"Large thermos",price:25}],variations:["Backyard version . less epic but way more convenient","Camping version . combine with an overnight trip","Rooftop version . if you have building access"],is_trending:false,is_top_week:false,is_new_release:false},
